...
|---------|---------|-------------|
| 30.2 (latest) | debian | `bitcoinknots/bitcoin:30.2`, `:30`, `:latest` |
| 30.2 (latest) | alpine | `bitcoinknots/bitcoin:30.2-alpine`, `:30-alpine`, `:alpine` |
| 29.2 | debian | `bitcoinknots/bitcoin:29.2`, `:29` |
| 29.2 | alpine | `bitcoinknots/bitcoin:29.2-alpine`, `:29-alpine` |
| master | debian | `bitcoinknots/bitcoin:master` |
| master | alpine | `bitcoinknots/bitcoin:master-alpine` |
